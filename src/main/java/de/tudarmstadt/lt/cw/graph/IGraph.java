...
public interface IGraph<N, E> extends Iterable<N>{
	 ...
	 */
	public abstract IGraph<N, E> undirectedSubgraph(Collection<N> subgraphNodes);
	 ...
	 * <b>NOTE: The behaviour of this graph when nodes are added or removed is undefined!</b>
	 */
	public abstract IGraph<N, E> subgraph(Collection<N> subgraphNodes);
